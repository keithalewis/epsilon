...
template <class X> X pp(X x, X y)
{
    return x / y;
}

template <class X> X dpp_dx([[maybe_unused]] X x, X y)
{
    return (X)1.0 / y;
}

template <class X> X dpp_dy(X x, X y)
{
    return -x / (y * y);
}

template <class X> X d2pp_dx_dy([[maybe_unused]] X x, X y)
{
    return -(X)1.0 / (y * y);
}
...
template <class X> X q(const X &x, const X &y, const X &z)
{
    return (x * x + y * y) / z;
}
...
template <class X> X dq_dy([[maybe_unused]] const X &x, const X &y, const X &z)
{
    return ((X)2 * y) / z;
}

template <class X> X dq_dz(const X &x, const X &y, const X &z)
{
    return -(x * x + y * y) / (z * z);
}

template <class X>
X d2q_dx_dy([[maybe_unused]] const X &x, [[maybe_unused]] const X &y,
            [[maybe_unused]] const X &z)
{
    return (X)0;
}
...
template <class X>
X d3q_dx_dy_dz([[maybe_unused]] const X &x, [[maybe_unused]] const X &y,
               [[maybe_unused]] const X &z)
{
    return (X)0;
}
...
template <class X> X p(const X &x)
{
    return 1 + 2 * x + 3 * x * x;
}
template <class X> X dp_dx(const X &x)
{
    return (X)2 + (X)6 * x;
}
template <class X> X d2p_dx2([[maybe_unused]] const X &x)
{
    return (X)6;
}
int mul_test4()
